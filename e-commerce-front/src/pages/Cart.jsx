    ...
    return (
        <div>
            ...
            <div className="font-[sans-serif] bg-white">
                <div className="lg:max-w-7xl max-w-xl mx-auto p-4">
                    <h2 className="text-3xl font-extrabold text-[#333] pt-3">Shopping Cart</h2>
                    <div className="grid lg:grid-cols-3 gap-8 items-start mt-8">
                        <div className="divide-y lg:col-span-2">
                            <div className="flex items-start justify-between gap-4 py-8">
                                <div className="flex gap-6">
                                    <div className="h-64 bg-gray-100 p-6 rounded">
                                        <img src='https://readymadeui.com/product_img_2.webp' className="w-full h-full object-contain shrink-0" />
                                    </div>
                                    <div>
                                        ...
                                        <div className="mt-6">
                                            <button type="button" className="flex flex-wrap gap-2 text-xl text-[#333]">
                                                ...
                                                <span className="bg-gray-100 px-2 py-1 rounded">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 fill-current" viewBox="0 0 42 42">
                            ...
                            <div className="flex items-start justify-between gap-4 py-8">
                                <div className="flex gap-6">
                                    <div className="h-64 bg-gray-100 p-6 rounded">
                                        <img src='https://readymadeui.com/product_img_1.webp' className="w-full h-full object-contain shrink-0" />
                                    </div>
                                    <div>
                                        <p className="text-md font-bold text-[#333]">Light Gray T-Shirt</p>
                                        <p className="text-gray-400 text-xs mt-1">1 Item</p>
                        ...
                        <div className="bg-gray-100 p-8">
                            ...
                            <ul className="text-[#333] mt-6 divide-y">
                                <li className="flex flex-wrap gap-4 text-md py-3">Subtotal <span className="ml-auto font-bold">$44.00</span></li>
                                <li className="flex flex-wrap gap-4 text-md py-3">Shipping <span className="ml-auto font-bold">$4.00</span></li>
                                <li className="flex flex-wrap gap-4 text-md py-3">Tax <span className="ml-auto font-bold">$4.00</span></li>
                                <li className="flex flex-wrap gap-4 text-md py-3 font-bold">Total <span className="ml-auto">$52.00</span></li>
                            </ul>
